...
//import core.ConnectionListener;//S.Saha 26/03/2023
...
public class DTNHost implements Comparable<DTNHost>{
	...
	//HashMap of Array
	public HashMap<Integer, int[]> mesTran = new HashMap<Integer, int[]>();
	//Array of HashMap of Array
	public List<HashMap<Integer , int[]>> policeMap  = new ArrayList<HashMap<Integer, int[]>>();
	//**MANUAL ENTRY OF NUMBER OF NODES**
	public int nrofNodes = 100;
	
	public int police = 10;
	public int lowergh = 10;
	public int uppergh = 20;
	
	
	
//	int nrof = Integer.parseInt(SimScenario.NROF_HOSTS_S);
	
//	public List<HashMap<Integer , int[]>> policeMap  = new ArrayList<HashMap<Integer, int[]>>();
	public int time[] = new int[nrofNodes];
	public int gH[] = new int[nrofNodes];
	...
	public DTNHost(List<MessageListener> msgLs,
		...
		this.path = null;
		//this.initialTrust(hostNames);
		//this.changingTrust(hostNames);
		...
		for(int i = 0; i < nrofNodes; i++) {
			HashMap<Integer, int[]> ini = new HashMap<Integer, int[]>();
			policeMap.add(ini);
		}
		time = new int[nrofNodes];
		gH = new int[nrofNodes];
	 ...
	 */
	public Path getPath() {
		System.out.println(this.path);//P.Kundu 18.03.2023
		return this.path;
	}
	 ...
	 */
	//Get this in MessageRelayEvent (but not being called)
	public void sendMessage(String id, DTNHost to) {
		
		
		this.router.sendMessage(id, to);
		System.out.println(this + " am sending to " + to); //S.Saha 18.03.2023 
	}
	...
	public int receiveMessage(Message m, DTNHost from) {
		...
		if(this.getAddress() == 34 || this.getAddress() == 23 || this.getAddress() == 11 || this.getAddress() == 8) {
			if(m != null) {
				//NOT WORKING!!!!!!
	 ...
	 */
	//Getting called from Finalize transfer in Connection.java
	int s[][] = new int[50][50];
	public void messageTransferred(String id, DTNHost from) {
		//System.out.println(id+" "+this.getAddress() + " received from " + from.getAddress()); //S.Saha 18/03/2023
