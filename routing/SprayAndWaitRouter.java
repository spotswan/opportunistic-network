...
public class SprayAndWaitRouter extends ActiveRouter {
	...
	//to use nrofcopies in calculating the trust function
	public static int copy[] = new int[50];
	...
	public Message messageTransferred(String id, DTNHost from) {
		...
		//System.out.println(this.getHost() + " having " + id + " -> " + nrofCopies);
		//copy[this.getHost().getAddress()] += nrofCopies;
		return msg;
	}
